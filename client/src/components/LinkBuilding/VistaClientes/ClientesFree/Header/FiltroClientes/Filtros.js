...
function mapStateToProps(state){return{ vistas : state.linkbuilding.vistas, filtros: state.linkbuilding.clientes.tipos.free.paneles.lista.filtros, empleado:state.empleado,  }}
