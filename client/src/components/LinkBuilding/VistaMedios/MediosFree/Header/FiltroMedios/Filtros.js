...
import { setVistaLinkBuilding, setFiltrosMediosFreeListaLinkbuilding, setFiltrosMediosPaidListaLinkbuilding } from '../../../../../../redux/actions';
...
function mapStateToProps(state){return{ vistas : state.linkbuilding.vistas, filtros_free: state.linkbuilding.medios.tipos.free.paneles.lista.filtros, filtros_paid: state.linkbuilding.medios.tipos.paid.paneles.lista.filtros }}
function  matchDispatchToProps(dispatch){ return bindActionCreators({ setVistaLinkBuilding, setFiltrosMediosFreeListaLinkbuilding,setFiltrosMediosPaidListaLinkbuilding }, dispatch) }
