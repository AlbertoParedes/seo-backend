...
class EnlacesDisponibles extends Component {
  ...
  saveData = () => {
    ...
    multiPath[`Clientes/${this.props.id_cliente}/enlaces_disponibles`]=this.state.enlaces_disponibles
    ...
    return(
      <div className='sub-container-informacion'>
        ...
        {this.state.enlaces_disponibles.length>0?
          ...
          :
          <div class="div_info_panel_linkbuilding">No hay enlaces disponibles</div>
        }
...
export default connect(mapStateToProps)(EnlacesDisponibles);
