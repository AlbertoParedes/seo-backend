...
class ItemEnlacePaid extends Component {
  ...
  guardarEnlace = (link) => {
    var multiPath = {}
    if (link.trim() === '') {
      multiPath[`Servicios/Linkbuilding/Paid/Enlaces/clientes/${this.props.cliente_seleccionado.id_cliente}/mensualidades/${this.props.fecha}/enlaces/${this.props.enlace.id_enlace}/fecha_fin`] = null
      multiPath[`Servicios/Linkbuilding/Paid/Enlaces/clientes/${this.props.cliente_seleccionado.id_cliente}/mensualidades/${this.props.fecha}/enlaces/${this.props.enlace.id_enlace}/enlace`] = null
      multiPath[`Servicios/Linkbuilding/Paid/Enlaces/clientes/${this.props.cliente_seleccionado.id_cliente}/mensualidades/${this.props.fecha}/enlaces/${this.props.enlace.id_enlace}/done_by`] = null
      ...
      multiPath[`Servicios/Linkbuilding/Paid/Enlaces/clientes/${this.props.cliente_seleccionado.id_cliente}/mensualidades/${this.props.fecha}/enlaces/${this.props.enlace.id_enlace}/fecha_fin`] = (+ new Date())
  ...
  render() {
    ...
    var
      beneficio = '-', beneficioCliente = this.props.cliente_seleccionado.servicios.linkbuilding.paid.home.mensualidades[this.props.fecha] ? this.props.cliente_seleccionado.servicios.linkbuilding.paid.home.mensualidades[this.props.fecha].beneficio : 0,
        ...
        */}
        ...
        {this.props.cliente_seleccionado.servicios.linkbuilding.paid.micronichos.activo ?
          <td className='lb-enlaces-paid-medio pr' onClick={() => this.openMicronichos(editable, done_by)}>
            <span className="span_edit">
              ...
              {editable ? <i className="material-icons span_i_edit_input idit_icon icon_seleccionable description-enlace-icon">arrow_drop_down</i> : null}
        ...
        <td className='lb-enlaces-paid-medio pr' onClick={() => this.openMedios(editable, done_by)}>
          <span className="span_edit">
            ...
            {enlace.id_medio && this.props.medios[enlace.id_medio].descripcion && this.props.medios[enlace.id_medio].descripcion.trim() !== '' ?
            ...
            {this.state.show_medios ?
              <ListaMediosDisponibles
                bote={this.props.cliente_seleccionado.servicios.linkbuilding.paid.bote}
                enlace={enlace}
                cerrarClick={true}
                cleanLink={true}
                opcionEliminar={enlace.id_medio ? true : false}
                inversionMensualString={this.props.inversionMensualString}
                title_eliminar='eliminar'
            ...
            {this.state.show_description ?
              <PopUpDescription text={this.props.medios[enlace.id_medio].descripcion} close={(e) => this.showDescripcion(e, false)} />
              : null}
          </span>
        </td>
...
export default connect(mapStateToProps, matchDispatchToProps)(ItemEnlacePaid);
