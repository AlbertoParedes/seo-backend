...
class RadioButton extends Component {
    ...
    render() {
      return (
        <label className={`checkbox-w2a ${his.props.checked?'checkbox-w2a-active':''}`} onClick={event => this.checkItem(event.currentTarget)}  data-checked={this.props.checked ? true : false} >Checkbox 14</label>
